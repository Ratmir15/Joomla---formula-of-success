...
$tmp_lng = strtolower($lang->getBackwardLang());
    ...
    <table border="0" width="90%">
	    <tr>
		    ...
		    <td width="80%"><b>Xmap 1.2.6 Stable</b></td>
	    </tr>
	    <tr>
		    ...
		    <td width="80%"><b>2009 by <a target="_blank" href="http://www.joomla.vargas.co.cr/">Guillermo Vargas</a>.</b></td>
	    </tr>
		<tr>
	    ...
	    <tr>
		    ...
		    <td width="80%"><b><a target="_blank" href="http://www.sefbook.de">http://www.joomla.vargas.co.cr/</a></b></td>
	    </tr>
		<tr>
			...
			<br> </br>
			<font color="green"><b>Xmap 1.2.6 has been installed successfully! Thank you for using Xmap! Settings can be configured in the <a href="index2.php?option=com_xmap">&rarr; component menu</a>!<br /></b><br />
			<br> </br></td>
		</tr>
	    <tr>
	      <td>&nbsp;</td>
