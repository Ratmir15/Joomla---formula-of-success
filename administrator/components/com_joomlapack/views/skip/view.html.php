 ...
 *
 */
class JoomlapackViewSkip extends JView
{
	function display()
	{
		...
		// Add toolbar buttons
		JToolBarHelper::title(JText::_('JOOMLAPACK').': <small><small>'.JText::_('DCS').'</small></small>');
		...
		JoomlapackHelperUtils::addLiveHelp('dcs');
