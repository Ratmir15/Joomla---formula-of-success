  ...
  <script language="javascript" type="text/javascript">
           ...
           function copyTitle(){
            ...
            if (document.getElementById("duplicateTitle").checked){                            
                for (i=1;i<<?php echo $this->params->get('nbMassSections')+1; ?>;i++){
      ...
      <h1><?php  echo  JText::_("MASS SECTIONS");?></h1>
	  <form action="index2.php?act=createMassSections" method="post" name="adminForm" id="adminForm" class="adminForm">
            ...
            <tr>
                <td>
                <fieldset>      
                    <legend><?php echo JText::_("CREATE UP TO")." ".$this->params->get('nbMassSections')." ". JText::_("SECTIONS IN A ROW");?></legend> 
                    <table border="0" cellpadding="3" cellspacing="0">

                    <?php $k = 0;
						for ($i=1;$i<$this->params->get('nbMassSections')+1;$i++) { ?>
                         <tr bgcolor="<?php echo($k==0)?"#f9f9f9":"#eeeeee";?>">
                            <td><?php  echo  JText::_("SECTION")." ".$i; ?>: <?php echo JText::_("TITLE");?></td>
