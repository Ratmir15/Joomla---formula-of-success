...
cols:"Столбцы",
rows:"Строки",
cellspacing:"Межклеточное расстояние",
cellpadding:"Клеточный отступ",
border:"Граница",
align:"Выравнивание",
...
cell_row:"Обновить все ячейки строки",
cell_all:"Обновить все ячейки таблицы",
row_row:"Обновить текущую строку",
row_odd:"Обновить нечетные строки таблицы",
row_even:"Обновить четные строки таблицы",
row_all:"Обновить все строки таблицы",
thead:"Шапка таблицы",
tbody:"Тело таблицы",
tfoot:"Основание таблицы",
scope:"Область(границы) видимости",
...
missing_scope:"Вы уверены, что хотите продолжать не обозначив границы ячеек шапки таблицы? Без этого, возможно, некоторым пользователям будет затруднительно понять, что за содержимое или информация находятся в таблице .",
...
frame_cols:"колонки",
frame_all:"все",
rules:"Линейки(масштаб)",
rules_void:"пустой",
rules_above:"выше",
rules_below:"ниже",
rules_hsides:"hsides",
rules_lhs:"левая сторона",
rules_rhs:"правая сторона",
rules_vsides:"vsides",
rules_box:"бокс",
